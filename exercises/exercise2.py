...
print(f"Numero maximo: {maximo_encadenado(1,10,5)}")
print(f"Numero maximo: {maximo_encadenado(5, 10, 1)}")
print(f"Numero maximo: {maximo_encadenado(5, 10, 5)}")
print("###############################################")
print(f"Numero maximo: {maximo_encadenado(4, 9, 18)}")
print(f"Numero maximo: {maximo_encadenado(9, 4, 18)}")
print(f"Numero maximo: {maximo_encadenado(9, 9, 18)}")
print("###############################################")
print(f"Numero maximo: {maximo_encadenado(24, 9, 18)}")
print(f"Numero maximo: {maximo_encadenado(24, 18, 9)}")
print(f"Numero maximo: {maximo_encadenado(24, 18, 18)}")
...
print(f"Numero maximo cuadruple: {maximo_cuadruple(1, 10, 5, -5)}")
print(f"Numero maximo cuadruple: {maximo_cuadruple(4, 9, 18, 6)}")
print(f"Numero maximo cuadruple: {maximo_cuadruple(24, 9, 18, 20)}")
print(f"Numero maximo cuadruple: {maximo_cuadruple(24, 9, 18, 30)}")
...
print(f"Numero maximo arbitrario: {maximo_arbitrario(1, 10, 5, -5)}")
print(f"Numero maximo arbitrario: {maximo_arbitrario(4, 9, 18, 6)}")
print(f"Numero maximo arbitrario: {maximo_arbitrario(24, 9, 18, 20)}")
print(f"Numero maximo arbitrario: {maximo_arbitrario(24, 9, 18, 30)}")
# # NO MODIFICAR - INICIO
