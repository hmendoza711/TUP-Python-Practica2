...
print(f"El numero mayor entre 10 y 5 es : {maximo_basico(10,5)}")
assert maximo_basico(9, 18) == 18
print(f"El numero mayor entre 9 y 18 es : {maximo_basico(9,18)}")
# NO MODIFICAR - FIN
...
print(f"Maximo libreria mayor entre 10 y 5 es : {maximo_libreria(10,5)}")
assert maximo_libreria(9, 18) == 18
print(f"Maximo libreria mayor entre 9 y 18 es : {maximo_libreria(9,18)}")
# NO MODIFICAR - FIN
...
print(f"Maximo ternario mayor entre 10 y 5 es : {maximo_ternario(10,5)}")
assert maximo_ternario(9, 18) == 18
print(f"Maximo ternario mayor entre 9 y 18 es : {maximo_ternario(9,18)}")
# NO MODIFICAR - FIN
